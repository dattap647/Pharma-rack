      ...
      <MDBContainer fluid className="p-4 g-1 align-items-center mx-2">
        <MDBRow>
          <MDBCol sm="6" className="d-none d-sm-block px-0">
            <img
              src={require("../assets/medium.avif")}
              alt="login"
              className="w-100 h-100 rounded-1"
              style={{ objectFit: "fit", objectPosition: "left" }}
            />
          </MDBCol>
          <MDBCol sm="6">
            <MDBCard>
              <MDBCardBody className="p-5  text-left">
                ...
                <div className="d-flex flex-column align-items-center ">
                  <p
                    className=" mb-3 pb-lg-3  text-left"
                    onClick={handleForReset}
                  >
                    Reset
                  </p>
                  <p className="ms-5 ">
                    Don't have an account?{" "}
                    <a href="SignUp" style={{ color: "#687EFF" }}>
                      Register here
                    </a>
                  </p>
                </div>
